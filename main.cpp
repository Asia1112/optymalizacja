...
void lab1()
{
	...
	// Warunki pocz¹tkowe
	matrix Y0(3, 1);
	Y0(0) = 5.0;   // Pocz¹tkowa objêtoœæ w zbiorniku A (VA)
	Y0(1) = 1.0;   // Pocz¹tkowa objêtoœæ w zbiorniku B (VB)
	Y0(2) = 20.0;  // Pocz¹tkowa temperatura w zbiorniku B (TB)

	// Czas symulacji
	double t0 = 0.0;            // Pocz¹tkowy czas
	double tend = 2000.0;       // Koñcowy czas symulacji
